# Plano de Exploração — nerdminertui
...
- [x] **Archaeologist** — Análise do módulo `cmd/tui`
- [x] **Archaeologist** — Análise do módulo `internal/config`
- [x] **Archaeologist** — Análise do módulo `internal/model`
- [x] **Archaeologist** — Análise do módulo `internal/worker`
- [x] **Archaeologist** — Análise do módulo `internal/ui`
- [x] **Archaeologist** — Análise do módulo `internal/store`
- [x] **Archaeologist** — Análise do módulo `pkg/mining`
- [x] **Archaeologist** — Análise do módulo `pkg/format`
...
- [ ] **Redator** — OpenAPI (se aplicável) (Não aplicável)
